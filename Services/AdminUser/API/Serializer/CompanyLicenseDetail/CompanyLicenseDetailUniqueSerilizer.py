...
class CompanyLicenseDetailSerializerUnique(serializers.Serializer):
    company = serializers.IntegerField(required=True)  # Suponiendo que el ID de Company es un UUID
